...
import '../../../provider/usermodal.dart';
...
class AuthappBloc extends Bloc<AuthappEvent, AuthappState> {
  ...
  AuthappBloc({required AuthRepository authRepository}):_authRepository= authRepository,
   super(authRepository.currentuser.isNotEmpty? AuthappState.authenticated(authRepository.currentuser):
